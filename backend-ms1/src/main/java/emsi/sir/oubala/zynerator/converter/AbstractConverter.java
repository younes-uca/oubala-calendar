package emsi.sir.oubala.zynerator.converter;


import emsi.sir.oubala.zynerator.bean.Etablissement;
import emsi.sir.oubala.zynerator.dto.EtablissementDto;

import emsi.sir.oubala.zynerator.util.ListUtil;
import emsi.sir.oubala.zynerator.audit.AuditBusinessObject;
import emsi.sir.oubala.zynerator.bean.BusinessObject;
import emsi.sir.oubala.zynerator.dto.AuditBaseDto;
import emsi.sir.oubala.zynerator.dto.BaseDto;
import emsi.sir.oubala.zynerator.util.DateUtil;
import emsi.sir.oubala.zynerator.util.RefelexivityUtil;
import emsi.sir.oubala.zynerator.util.StringUtil;
import emsi.sir.oubala.zynerator.util.Utils;
